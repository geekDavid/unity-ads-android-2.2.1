...
//        if (window != null) {
//            Log.e("main", "设置AdUnitActivity窗体1像素 ");
...
//        }
        ...
        Log.e(TAG, "onResume设置ActicityID" );
...
//            @Override
//            public void run() {
//                Toast.makeText(AdUnitActivity.this, "关闭页面", Toast.LENGTH_SHORT).show();
//                Log.e("adUnit", "关闭页面");
//                finish();
//            }
//        }, 10000);
...
//            WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.ADUNIT, AdUnitEvent.ON_FOCUS_LOST, _activityId);
    ...
    public void setViewFrame(String view, int x, int y, int width, int height) {
        ...
        Log.e(TAG, "setViewFrame: Activity ------------");
...
//        }
    ...
    public boolean setSystemUiVisibility(int flags) {
        ...
        Log.e(TAG, "----------设置setSystemUiVisibility ： " + flags);
