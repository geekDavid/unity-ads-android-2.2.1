...
public class WebPlayer extends WebView {
    ...
    final private String TAG = "WebPlayer";
            ...
            if (_jsString != null) {
                try {
                    if (Build.VERSION.SDK_INT >= 19) {
                        ...
                        loadUrl(_jsString);
                        Log.e(TAG, "onPageFinished: 页面加载完毕：" + _jsString);
                    }
                } catch (Exception e) {
    ...
    private class WebPlayerClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            Log.e(TAG, "onPageFinished: 页面加载完毕：" + url);
        ...
        public boolean shouldOverrideKeyEvent(WebView view, KeyEvent event) {
            ...
            if (hasReturnValue("shouldOverrideKeyEvent")) {
                Log.e(TAG, "onUnhandledKeyEvent: 允许点击返回值");
        ...
        public void onUnhandledKeyEvent(WebView view, KeyEvent event) {
            if (shouldCallSuper("onUnhandledKeyEvent")) {
                Log.e(TAG, "onUnhandledKeyEvent: 不允许点击");
                super.onUnhandledKeyEvent(view, event);
            }
            if (shouldSendEvent("onUnhandledKeyEvent")) {
                Log.e(TAG, "onUnhandledKeyEvent: 不允许点击sendEvent");
    ...
    private class WebPlayerChromeClient extends WebChromeClient {
        ...
        public void onShowCustomView(View view, CustomViewCallback callback) {
            if (shouldCallSuper("onShowCustomView")) {
                Log.e(TAG, "onShowCustomView: 显示自定义试图");
                super.onShowCustomView(view, callback);
            }
            if (shouldSendEvent("onShowCustomView")) {
                Log.e(TAG, "onShowCustomView: 显示自定义视图sendEvent");
        ...
        public void onHideCustomView() {
            if (shouldCallSuper("onHideCustomView")) {
                Log.e(TAG, "onHideCustomView: 隐藏自定义试图");
                super.onHideCustomView();
            }
            if (shouldSendEvent("onHideCustomView")) {
                Log.e(TAG, "onHideCustomView: 隐藏自定义试图sendEvent");
        ...
        public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
            ...
            if (hasReturnValue("onCreateWindow")) {
                Log.e(TAG, "onCreateWindow: 创建窗体返回值");
        ...
        public void onRequestFocus(WebView view) {
            if (shouldCallSuper("onRequestFocus")) {
                Log.e(TAG, "onRequestFocus: 请求窗体焦点");
                super.onRequestFocus(view);
            }
            if (shouldSendEvent("onRequestFocus")) {
                Log.e(TAG, "onRequestFocus: 请求窗体焦点sendEvent");
        ...
        public void onCloseWindow(WebView window) {
            if (shouldCallSuper("onCloseWindow")) {
                Log.e(TAG, "onCloseWindow: 关闭窗体");
                super.onCloseWindow(window);
            }
            if (shouldSendEvent("onCloseWindow")) {
                Log.e(TAG, "onCloseWindow: 关闭窗体sendEvent");
